...
public class ServiceLayerPerson
{
    ...
    {
        //string strConnection = System.Configuration.ConfigurationManager.ConnectionStrings["ClassProjectDataBase"].ConnectionString;
    ...
    {
        SqlConnection sqlConnection = new SqlConnection("data source=.;initial catalog=ClassProjectDataBase;integrated security=True;");
        String SQLQuery = "UPDATE people SET password = @newpassword where username = @oldpassword";
        SqlCommand command = new SqlCommand(SQLQuery, sqlConnection);
